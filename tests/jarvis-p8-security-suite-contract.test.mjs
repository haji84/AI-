...
test("P8 security suite remains explicit, focused, and CI-enforced", () => {
  ...
  for (const requiredTest of [
    ...
    "tests/jarvis-sec005-nonce-protection.test.ts",
    "tests/jarvis-sec006-replay-protection.test.ts",
    "tests/jarvis-sec007-clock-stale-request.test.ts",
    "tests/jarvis-sec008-device-allowlist.test.ts",
    "tests/jarvis-sec009-capability-authorization.test.ts",
    "tests/jarvis-sec010-private-ingress.test.mjs",
    ...
    "tests/jarvis-sec016-remote-assist-audit.test.ts",
