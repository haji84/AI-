...
```json
{
  ...
  "status": "PARTIAL",
  "blocker": "Bounded owner material intake, outcome execution/download and explicit historical/correction UI are integrated. Normal conversational DoD semantics, unrestricted novel decomposition/executable skills, historical claim revalidation, teaching/R16 experiment/R17 promotion integration and physical/cross-device acceptance remain.",
  "platform_limit": null,
  "fallback": null,
  "next_action": "Finish exact-head CI/evidence for explicit owner material intake and historical/correction controls. Then connect ordinary Goal intake to trusted nonempty success criteria and semantic outcome verification; continue verified historical/teaching/research and model-improvement integration without promoting raw claims or weakening existing gates.",
  "last_verified_commit": null,
  "source_decisions": [
