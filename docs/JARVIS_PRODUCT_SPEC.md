...
```json
{
  ...
  "implementation_refs": [
    ...
    "src/jarvis/command-input-audit.ts",
    "src/app/api/command/route.ts"
  ],
  "test_refs": [
    "tests/jarvis-completion-engines.test.ts",
    "tests/jarvis-completion-readiness.test.ts",
    "tests/jarvis-command-input-audit.test.ts"
  ],
  "evidence_refs": [
...
```json
{
  ...
  "implementation_refs": [
    ...
    "src/jarvis/fact-audit-runtime.ts",
    "src/app/api/jarvis/facts/route.ts",
    "src/app/jarvis/research/FactAuditPanel.tsx"
  ],
  "test_refs": [
    "tests/jarvis-completion-engines.test.ts",
    "tests/jarvis-completion-readiness.test.ts",
    "tests/jarvis-fact-audit-runtime.test.ts",
    "tests/jarvis-fact-conservative.test.ts"
  ],
  "evidence_refs": [
