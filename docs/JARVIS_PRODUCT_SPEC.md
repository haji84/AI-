...
```json
{
  ...
  "test_refs": [
    ...
    "tests/jarvis-recording-cancellation.test.ts"
  ],
  "evidence_refs": [
    "docs/audit/jarvis-p3-reconciliation.md",
    "docs/audit/jarvis-recording-cancellation.md"
  ],
  "status": "PARTIAL",
  "blocker": "録画のaudit admission/停止/deadline/session再検証を#707で修正しnegative tests通過。認証付き閲覧#709、実HTTP全経路と実機Evidenceが残る。",
  "platform_limit": null,
  "fallback": null,
  "next_action": "#709の記録閲覧を統合し、実機record/stop/playbackとoffline recovery Evidenceを取得する。",
  "last_verified_commit": null
}
```
