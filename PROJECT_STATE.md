...
NEXT_PRIORITY: #859 Android8 static-capture and browser-input emulator regressions repaired; 978 tests and emulator single-view controls pass (docs/evidence/859-android8-emulator.md). Next signer-matched physical Android8 canary and enrollment-safe release coordination; no production deployment or physical PASS. Retain local-video inference/replay and other #681 acceptance gaps.
