...
OPEN_PRS: #1213 additive IDs/conversation/UI candidate, local1463/P8 331 PASS, exact-head CI pending; #1208 Windows worker 4051f91 CI35795873001 SUCCESS held unmerged; #1195/#883/#884 physical-facing holds unchanged
...
NEXT_PRIORITY: Complete #1205 exact-head CI and scope/production review. New-ID, stored-reference/correction/withdrawal and Tasks/Work UI software paths pass isolated tests/browser QA; no live publisher/production proof. Preserve physical holds; broader all-route semantic/provider audit and physical Windows acceptance remain.
