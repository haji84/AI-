...
const stageModes: Record<ResearchStageId, CampaignExecutionMode> = {
  R1: "local-model", R2: "local-model", R3: "external-runtime", R4: "local-model", R5: "human-review",
  R6: "local-model", R7: "local-safe", R8: "local-model", R9: "local-safe", R10: "local-safe",
  R11: "local-model", R12: "external-runtime", R13: "local-model", R14: "local-safe", R15: "local-safe",
  R16: "local-model", R17: "human-review", R18: "local-model", R19: "external-runtime", R20: "human-review",
};
