...
const ALLOWED: Readonly<Record<DevelopmentJobPhase, ReadonlySet<DevelopmentJobPhase>>> = {
  QUEUED: new Set(["PLANNING", "RECOVERING", "WAITING_FOR_CONNECTIVITY", "WAITING_FOR_RESOURCE", "HUMAN_GATE", "BLOCKED", "CANCELLED"]),
  PLANNING: new Set(["IMPLEMENTING", "WAITING_FOR_CONNECTIVITY", "WAITING_FOR_RESOURCE", "RECOVERING", "HUMAN_GATE", "BLOCKED", "CANCELLED"]),
  IMPLEMENTING: new Set(["IMPLEMENTING", "VERIFYING", "WAITING_FOR_CONNECTIVITY", "WAITING_FOR_RESOURCE", "RECOVERING", "HUMAN_GATE", "BLOCKED", "CANCELLED"]),
  ...
  RECOVERING: new Set(["PLANNING", "IMPLEMENTING", "VERIFYING", "RECOVERING", "WAITING_FOR_CONNECTIVITY", "WAITING_FOR_RESOURCE", "HUMAN_GATE", "BLOCKED", "CANCELLED"]),
  READY_TO_PUBLISH: new Set(["PUBLISHING", "RECOVERING", "WAITING_FOR_CONNECTIVITY", "HUMAN_GATE", "BLOCKED", "CANCELLED"]),
  PUBLISHING: new Set(["PUBLISHING", "VERIFYING", "COMPLETED", "RECOVERING", "WAITING_FOR_CONNECTIVITY", "HUMAN_GATE", "BLOCKED", "CANCELLED"]),
