...
export type Observation = { signature: string; profile: DeviceProfile; targets: Array<{ selector: string; x: number; y: number; left: number; top: number; right: number; bottom: number; safeNavigation: boolean }>; protectedScreen: boolean };
