...
# User-scoped scheduled tasks avoid the admin/token dependency of re-registering
# an already configured GitHub runner as a Windows service.
...
# Run the watchdog immediately so persistence installation is also a live health test.
