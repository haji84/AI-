...
try {
  ...
  compass.updateState({
    status: "READY",
    nextAction: `Implement ${fixture} so its complete content is exactly runtime-daily`,
    blockers: [],
  });
